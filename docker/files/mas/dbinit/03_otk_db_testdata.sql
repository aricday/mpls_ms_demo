...
VALUES ('54f0c455-4d80-421f-82ca-9194df24859d', 'a0f2742f-31c7-436f-9802-b7015b8fd8e6', 'ENABLED', 'admin', 'TestClient2.0', 'OAuth2Client', 'mas_storage oob scope_test', 'https://mas.docker.local:8443/oauth/v2/client/authcode?auth=done,https://mas.docker.local:8443/oauth/v2/client/implicit?auth=done', '{}');
--
--
-- Create MDC client
--
