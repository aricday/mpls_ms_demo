...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    UITabBar.appearance().barTintColor = Common.Constants.themeColor
    // Sets the default color of the background tint when selected of the UITabBar
    UITabBar.appearance().tintColor = Common.Constants.themeSelectedColor
    ...
    // Sets the default color of the background tint when selected of the UINavigationBar
    UINavigationBar.appearance().tintColor = Common.Constants.themeSelectedColor
    // Sets the default not selected color for unselected items
...
//    
  ...
  lazy var persistentContainer: NSPersistentContainer = {
     ...
     */
    let container = NSPersistentContainer(name: "MicroservicesDemo")
